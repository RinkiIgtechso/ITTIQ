                        ...
                        <Zoom triggerOnce='true'>
                            ...
                            <div className='py-3 px-2 flex justify-between'>
                                <div className='flex gap-1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="xl:w-4 xl:h-4 lg:w-3 lg:h-3 w-3 h-3 text-gray-600">
                                ...
                                <div className='flex gap-1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="xl:w-4 xl:h-4 lg:w-3 lg:h-3 w-3 h-3text-gray-600">
