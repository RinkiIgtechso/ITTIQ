  ...
  return (
    <div className='p-4'>
      <div className='mt-2 mb-3'>
        <div className='text-center text-3xl font-bold'>Choose  Your Career Path</div>
        <div className='mt-2 text-center text-sm text-secondary-200 w-75 m-auto'>Nous nous engageons à fournir une éducation technologique à la prochaine génération de leaders au Bénin, en promouvant l'égalité et l'autonomisation</div>
      </div>
